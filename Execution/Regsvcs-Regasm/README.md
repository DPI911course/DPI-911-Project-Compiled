...
To avoid detection, adversaries look to use genuine software in order to execute code. In this case, regsvcs and regasm can be used to bypass application whitelisting 
